...
class HealthController private extends BaseController with HealthEndpoint {
  val health: Full[Unit, Unit, Unit, Throwable, String, Any, Task] = healthEndpoint
    .serverLogicSuccess[Task](_ => ZIO.succeed("All good"))

  private val errorRoute: Full[Unit, Unit, Unit, Throwable, String, Any, Task] = errorEndpoint
